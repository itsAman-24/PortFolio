...
export const icons = [c, cpp, java, html, css, js , redux, talwind, bootstrap, MUI, firebase, nodejs]
...
export const experiences = [
  {
    ...
    desc: [
      "Built a client based Web3 app, offering an advanced derivative platform",
